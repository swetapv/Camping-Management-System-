...
public class Home extends JFrame{
    ...
    public Home(String username) {
        super("Camping Management System");
	this.username = username;
        setForeground(Color.CYAN);
        setLayout(null); 

        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/camp.jpeg"));
	...
	NewLabel.setBounds(0, 0, 1950, 1000); 
        ...
        JLabel l1 = new JLabel("Camping at Blue Heaven, Manali");
	l1.setForeground(Color.WHITE);
        l1.setFont(new Font("Tahoma", Font.PLAIN, 55));
	l1.setBounds(380, 60, 1000, 100);
	NewLabel.add(l1);
	...
	m1.add(mi3);
        ...
        mi3.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                try{
                    new ViewCus(username).setVisible(true);
                }catch(Exception e ){}
            }
	});
	...
	mi5.addActionListener(new ActionListener(){
        ...
        JMenu m3 = new JMenu("ACCOMODATION");
        m3.setForeground(Color.BLUE);
	menuBar.add(m3);
        
        JMenuItem mi8 = new JMenuItem("BOOK ACCOMODATION");
	m3.add(mi8);
        
        
        JMenuItem mi10 = new JMenuItem("VIEW BOOKED DETAILS");
	m3.add(mi10);
