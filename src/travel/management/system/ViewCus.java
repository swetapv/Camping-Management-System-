...
public class ViewCus extends JFrame implements ActionListener  {
    ...
    ViewCus(String username) {
        ...
        Image i2 = i1.getImage().getScaledInstance(626, 180,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel image = new JLabel(i3);
        image.setBounds(0,450,626,150);
        add(image);
                
        ImageIcon i4  = new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/viewall.jpg"));
        Image i5 = i4.getImage().getScaledInstance(626, 180,Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        JLabel l2 = new JLabel(i6);
        l2.setBounds(615,450,626,150);
        add(l2);
